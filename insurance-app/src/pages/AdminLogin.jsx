  ...
  return (
    <div className="flex items-center justify-center min-h-screen bg-gray-200 w-full animate-in fade-in duration-700">
      <div className="clay p-10 w-96 shadow-2xl">
        <h2 className="text-3xl font-black mb-8 text-center text-gray-800 tracking-tight">Admin Login</h2>
        ...
        <button 
          className="w-full bg-blue-600 text-white font-black p-4 mt-8 rounded-2xl hover:bg-blue-700 hover:shadow-blue-200 transition-all shadow-xl active:scale-95" 
          onClick={handleLogin}
        >
          Secure Login
        </button>
        <div className="mt-8 text-center border-t border-gray-300 pt-6">
            <a href="/" className="text-sm font-bold text-gray-500 hover:text-blue-600 transition-colors flex items-center justify-center gap-2">
