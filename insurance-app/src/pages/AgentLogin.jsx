  ...
  return (
    <div className="flex items-center justify-center min-h-screen bg-[#e0e5ec] w-full">
      <div className="clay p-10 w-96 shadow-2xl">
        ...
        <button
          className="w-full bg-purple-600 text-white font-black p-4 mt-8 rounded-2xl hover:bg-purple-700 transition-all shadow-xl active:scale-95 disabled:opacity-60"
          onClick={handleLogin}
          disabled={loading}
        >
        ...
        <div className="mt-6 text-center">
          <a href="/" className="text-sm font-bold text-gray-400 hover:text-purple-600 transition-colors">← Back to Home</a>
        </div>
      </div>
    </div>
  );
